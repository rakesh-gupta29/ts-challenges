...
type MyCapitalize<T> = T extends `${infer firstChar}${infer rest}`
  ? `${firstChar extends keyof CapitalLettersMap
      ? CapitalLettersMap[firstChar]
      : firstChar}${rest}`
  : T;
