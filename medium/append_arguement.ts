...
// answer is creating another function with all args and appending the arg to the function.
type AppendArgument<Fn, A> = Fn extends (
  ...args: infer ArgType
) => infer ReturnType
  ? (...args: [...ArgType, A]) => ReturnType
  : never;

//  infer the type of args as a tuple and append to this tuple.
