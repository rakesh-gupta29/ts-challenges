...
// iterator over only those key which are in K . before that extending K to keyof T is important.
// otherwise we can't extens it to query T

type Man = {
  name: string;
  age: number;
};
type Selected = MyPick2<Man, "age">; // { age : number }
