...
type FilterOut<T extends any[], Bad> = T extends [infer F, ...infer Rest]
  ? [F] extends [Bad]
    ? [...FilterOut<Rest, Bad>]
    : [F, ...FilterOut<Rest, Bad>]
  : T;

// types are disbributive over the set by default. Wrapping them in a tuple stops this behaviour.
